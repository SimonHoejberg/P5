...
and the cameras centers is stored in \textc{temp} for future
calculations. The boolean on \textbf{line 3} tells that the blob is in the
view of the camaéra, this boolean is used in the \textc{GetDataAndCalculate}
...
(\textbf{lib\_direction!=0}), the \textc{GetSpeed} function is called in order
to determine the targets speed. This function is shown in \fix{\autoref{}}{is it
the right ref}.
