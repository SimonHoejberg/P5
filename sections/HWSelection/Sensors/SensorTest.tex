...
\centering
\begin{tikzpicture}
  \begin{axis}[xlabel={Measured distance}, ylabel={Actual distance}, xmin=0,
  ymin=0, minor tick num = 3, /pgfplots/grid = both, axis lines = left] 
  \addplot[green, mark=*] table {graphData/sensorShielded1.dat};
  \addplot[blue, mark=*] table {graphData/sensorShielded3.dat};
  \end{axis} 
\end{tikzpicture}
