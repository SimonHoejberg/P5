...
% \begin{tikzpicture}
%   \begin{axis}[xlabel={$x$}, ylabel={$y$}, ylabel style={rotate=270}, xmin=0,
%   ymin=0, minor tick num = 3, /pgfplots/grid = both, axis lines = left] \addplot
%   table {graphData/test1.dat};
%   \end{axis}
% \end{tikzpicture}
...
The setup of the camera is quite simple and is done using a computer. It is
