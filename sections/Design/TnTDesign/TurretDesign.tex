...
considerable chance of misfiring or shooting sligthly too far. While the
problem with misfires are not easily solvable, the problem with shooting too far
or too wide can possibly be solved by increasing the size of the target. In
addition, the tests conducted in \autoref{SensorTest} also show that the sensors on the turret
are incapable of sensing the target any further than the piston design can
shoot. Due to this fact, the possible distances of the other designs has
