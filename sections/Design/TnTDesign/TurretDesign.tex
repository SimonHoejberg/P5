...
The ballista was considered as depending on how far back the projectile
can be pulled, a shot can be fired with a lot of power. The obvious drawbacks
...
able to shoot again. This design can be seen in \autoref{ballista}. This
design was dismissed because of these drawbacks.\nl

The launcher was considered since it is able to lauch projectiles quickly, and
depening on how good the rotating wheels are, with a lot of force. It utilizes
two wheels placed side by side, spinning in opposite directions, with the
projectile pushed through, see \autoref{tennisball}. When trying to build this
...
not possible to fire with enough force.\nl

The piston design uses a piston that pushes the projectile through a mouth piece
...
design can be seen in \autoref{piston}. This design has several advantages, LEGO
Technic has a ball launcher which can store several small ball projectiles.
This allows us to have an easily reloadable and fast firing cannon, which can
hold up to 6 shots.\nl

The piston design was chosen as the
