...
domain for the vectors are presented in \autoref{vecDom}.
...
construct the table which can be seen in \autoref{SDtable}. For instance, there
...
vector. As such, the probability table for \texttt{SD\_0} and \texttt{SD\_2}
can be seen in seen \autoref{SDtable}. While it seems there is little
...
distribution of the vectors is seen below in \autoref{Vector0Table}, while the
