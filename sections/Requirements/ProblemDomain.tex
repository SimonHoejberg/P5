...
% As the only initial requirements is to be able to beat Ren\'e's challenge, 
% 
% it is
% thus possible to construct an ideal scenario in order to better visualize how it
% might work.
% 
% it is
% possible to construct
% 
%  Based on our initial problem we can create a number of ideal
% scenarios, which can be used to analyze what problems could occur while the turret operates. 
% 
% 
% 
% 
