...
%     updated/changed to the above.}
  ...
  Based on these requirements and the anylysis it is now possible to make design
  choices about the construction of \namep, such that it is able to hit a
  target in motion. It is also possible to contruct a target that \name is
  able both detect and hit, based on the test of the camera and ultrasonic
  sensor. 
