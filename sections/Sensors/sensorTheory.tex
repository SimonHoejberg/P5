...
number of rectangles. Such a representation can be seen in \autoref{}.

\figx[0.4]{TwoBlops.PNG}{Visual representation of what the camera senses.}
...
\begin{itemize}
  ...
  \item Gathers information about: number of objects, color of objects and
...
\figx[0.4]{UltrasoundPic.jpg}{The two ultrasonic sensors and the camera mounted
on the turret.}
