...
\subsubsection{Camera tracking}%Will most likely need a better name
...
There are three different test that can be done, first to the how far
the camera can track an object, the second to determine which colour the camera
best sees and the third to determine if lighting up the object changed the
cameras abillity to track the colour \/ object.\nl
