...
\fix{As such, a model with sufficient memory, processing power and I/O
ports.}{What?} The arduino comes with its own programming language and IDE
...
\fix{\citep{ArduinoComponents}}{Bad source, we are not buying}. In addition, due
