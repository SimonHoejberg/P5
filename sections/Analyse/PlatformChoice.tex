...
\begin{enumerate}
  ...
  the NXT in number of available ports, \fix{it also allows flexibility in
  whether the ports are input or output and analog or digital.}{not true, if it
  is it needs a source}
