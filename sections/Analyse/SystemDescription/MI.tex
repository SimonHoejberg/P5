...
knowledge can be used to solve said problem \fix{\citep{MIBook}}{what pages?}.
...
\begin{itemize}
  ...
  \autoref{Serial2}.
 \figx[0.8]{Serial2}{A serial connetion with evidence on the middle node}
 ...
 \autoref{Convergent2}.
 \figx[0.8]{Convergent2}{A convergent connection with no evidece on the
 child node}
 ...
 \figx[0.8]{Divergent2}{A divergent connection with evidence on the parent node}
\end{itemize}
