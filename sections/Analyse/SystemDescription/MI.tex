...
\begin{enumerate}
  ...
  \item \fix{If what it does is appropriate to its circumstances and goals.}{
  Too much copy pasta}
  \item \fix{If it is flexible to changing environments and changing goals.}{
  Too much copy pasta}
  \item \fix{If it learns from experience.}{ Too much copy pasta}
  \item \fix{If it makes appropriate choices given its perceptual and
