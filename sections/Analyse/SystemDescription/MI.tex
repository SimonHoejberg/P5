...
How intelligent can be judged by:
...
\name is a turret, it needs to be able to represent the problem of hitting a
...
% \begin{itemize}
%   \item $p(S_0)$ - specifies the initial condition
...
% \figx{BeliefNetwork}{A belief network for position of \name}
 ...
 child node}
 \figx{convergent.JPG}{A convergent connection with evidence on the child node}
...
%  If structured correctly the Hidden markov model also makes
